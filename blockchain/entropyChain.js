...
const EntropyChain = function () {
	...
	function init() {
		genesisBlock = {
			...
			data: 'Genesis data. Welcome to EntropyChain!',
			previousHash: '-1',
			nonce: 0
		};
	...
	function proofOfStake(block) {
	
	}

	function proofOfAuthority(block) {
